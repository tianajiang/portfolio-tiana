...
Donglu's main form of interaction on social media is in a cancer support group on Facebook. In this group, members post about their life updates (including new workout routines and family activities), treatment experiences, personal milestones, and more. Donglu feels a genuine sense of joy when her friends in the cancer support group share positive updates and achievements, which often inspires her own fitness and health goals. However, she admits this "inspiration" might actually be jealousy, as she sometimes feels inadequate when comparing her own progress to theirs. She says, “Maybe I wasn’t inspired; maybe I was jealous, but it made me work a lot harder and want to exercise more.” This underscores the idea that seeing others' achievements can serve as a powerful motivator, pushing her to strive for her own improvement.

Along with this, Donglu's interview surfaced the importance of personalization. As a cancer patient in her 50s with a leg recovering from surgery, Donglu needs exercise routines that are specifically tailored to her current physical capabilities and health. She turns to her peers in the cancer group, as well as ChatGPT, to find workouts that accommodate her limitations and support her recovery. This highlights a broader need for fitness solutions that adapt to individual needs, ensuring that people like Donglu can find safe exercise routines suited to their unique situations.
...
4. **Sharing**
    - There is currently no good source for personalized and accessible workout recommendations. Even the workouts online labeled as "beginner friendly" are demonstrated by fit trainers who make it look easy. These workouts don't always match a person's abilities. Jung explained that being able to use her mom's workout routine and knowing that if her mom could do it, she could too, motivated her a lot. It also made her feel better to see her mom struggle with the exercise sometimes so that she knew it was normal to struggle.